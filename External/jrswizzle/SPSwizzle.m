...
+ (BOOL)sp_swizzleMethod:(SEL)origSel_ withMethod:(SEL)altSel_ error:(NSError**)error_ {
#if OBJC_API_VERSION >= 2
...
+ (BOOL)sp_swizzleClassMethod:(SEL)origSel_ withClassMethod:(SEL)altSel_ error:(NSError**)error_ {
	return [GetClass((id)self) sp_swizzleMethod:origSel_ withMethod:altSel_ error:error_];
}
