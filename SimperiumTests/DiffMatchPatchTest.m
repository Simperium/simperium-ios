...
- (void)testDiffCleanupSemanticLosslessTest {
  DiffMatchPatch *dmp = [DiffMatchPatch new];
  NSMutableArray *expectedResult = nil;
...
- (void)testDiffCleanupEfficiencyTest {
  DiffMatchPatch *dmp = [DiffMatchPatch new];
  NSMutableArray *expectedResult = nil;
...
- (void)testPatchMakeTest {
  ...
  text2 = [text1 stringByAppendingString:@"123"];
		// JLP: Our current changes produce the expected output!
